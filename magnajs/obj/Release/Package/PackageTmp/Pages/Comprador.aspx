<%@ Page Title="" Language="C#" MasterPageFile="~/includes/CYP.Master" AutoEventWireup="true" CodeBehind="Comprador.aspx.cs" Inherits="CYP.Pages.Comprador" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">

    <div ng-controller="comprador">
            ...
            <div class="filter mail-box filtros">
                <div class="row p-5">
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-5">
                                <input type="text" class="form-control" maxlength="500" ng-model="filtro.Nombre" key-enter="ObtenerCompradores()"
                                    placeholder="<%= this.GetMessage("lblBusquedaComprador") %>">
                            </div>
                    ...
                    <div class="col-md-4 text-right">
                        <button type="button" class="btn btn-link" ng-click="ObtenerCompradores()">
                ...
                <div ui-table="activities" st-fixed>
                    <table class="jsgrid-table" style="min-width: 500px">
                        <thead>
                            <tr>
                                <th ui-field width="5">
                                    <%= this.GetMessage("lblUsuarioComprador") %>
                                </th>
                                <th ui-field width="10">
                                    <%= this.GetMessage("lblNombreComprador") %>
                                </th>
                                <th ui-field width="10">
                        ...
                        <tbody>
                            <tr ng-repeat="item in compradores">
                                <td st-ratio="10">{{item.UsuarioComprador}}</td>
                                <td st-ratio="10">{{item.Nombre}}</td>
                                <td st-ratio="10">
                                    <input type="checkbox" ng-model="item.Active" disabled />
                                </td>
                                <td class="text-center" st-ratio="5">
                                    <button type="button" class="btn btn-link" ng-click="ObtenerComprador(item)">
        ...
        <div class="page-content" ng-show="esDetalle">
            <div class="row">
                <div class="col-sm-6">
                    <div class="subtitulo-color"><%= this.GetMessage("lblDetalleComprador") %></div>
                </div>
            ...
            <div class="mail-box" ng-form="forma" ng-class="{'submitted': submitted}">
                <div class="padding-form">
                    <div class="row mb">
                        <div class="col-sm-4">
                            <span class="label-color"><%= this.GetMessage("lblUsuarioComprador") %> </span>
                            <input type="text" ng-model="comprador.UsuarioComprador" class="form-control-input" required maxlength="20" />
                        </div>

                        <div class="col-sm-4">
                            <span class="label-color"><%= this.GetMessage("lblNombreComprador") %> </span>
                            <input type="text" ng-model="comprador.Nombre" class="form-control-input" required maxlength="100" />
                        </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <switcher ng-model="comprador.Active" true-label="<%= this.GetCommonMessage("lblSi") %>"
    ...
    <script src="../Scripts/pages/comprador.js"></script>
</asp:Content>
